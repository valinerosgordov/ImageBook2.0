<p style="color: #444444; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.4; margin-top: 0; margin-bottom: 10px;">
    Счет №${bill.id} на сумму ${bill.total} руб. успешно оплачен. Спасибо!
</p>

<p style="color: #444444; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.4; margin-bottom: 10px;">
    Ваш заказ на печатную продукцию ${vendor.name} передан в обработку.
    Вы можете отслеживать выполнение вашего заказа в личном кабинете в разделе "Заказы в обработке".
</p>

<p style="color: #444444; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.4; margin-bottom: 10px;">
    <b>Информация по счету №${bill.id} от ${bill.date?string["dd.MM.yyyy"]}</b>
</p>
...
<p style="color: #444444; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.4; margin-top: 10px; margin-bottom: 10px;">
    <#if deliveryMethod??>Доставка: ${deliveryMethod}<br></#if>
    <#if deliveryAddress??>Адрес: ${deliveryAddress}<br></#if>
    Стоимость доставки: ${deliveryCost} руб.
</p>
<p style="color: #444444; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.4; margin-top: 10px; margin-bottom: 0;">
    <b>Итого с доставкой: ${bill.total} руб.</b>
</p>