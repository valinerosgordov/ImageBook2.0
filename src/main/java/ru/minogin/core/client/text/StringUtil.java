...
public class StringUtil {
	...
	public static <T> String implodeByComma(Collection<T> values,
			Renderer<T> renderer) {
		Collection<String> parts = new ArrayList<String>();
		for (T value : values) {
			parts.add(renderer.render(value));
		}
		return implodeByComma(parts);
	}
	...
	public static String implodeAndWrap(String glue, String leftWrapper,
			String rightWrapper, Collection<String> parts) {
		StringBuffer sb = new StringBuffer();
		boolean isFirst = true;
	...
	public static String stripTagsExceptAnchor(String html) {
		if (html == null)
			return null;
	...
	public static Collection<String> split(String s, String separator) {
		String[] partsArray = s.trim().split(separator);
		Collection<String> parts = new ArrayList<String>();
