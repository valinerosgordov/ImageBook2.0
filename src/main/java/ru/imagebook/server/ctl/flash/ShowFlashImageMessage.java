...
public class ShowFlashImageMessage extends BaseMessage {
	...
	public ShowFlashImageMessage(String sessionId, int type, int size, int page, HttpServletResponse response) {
		super(FlashMessages.SHOW_FLASH_IMAGE);
