...
SELECT null id,
    ...
    `product`.`nonCalc`
FROM `product`
where  type = 11 and number = 7;

-- color ranges
insert into color_range select id, 0, 0 from product where type = 11 and number = 11;

-- albums
insert into album 
SELECT (select id from product where type = 11 and number = 11) id,
    `album`.`size`,
    `album`.`cover_size`,
...
FROM `album`
where id = (select id from product where type = 11 and number = 7);

-- cover_lam ranges

insert into cover_lam_range
select (select id from product where type = 11 and number = 11) product_id
     , number
     , _index
  from cover_lam_range where product_id = (select id from product where type = 11 and number = 7);
...
select (select id from product where type = 11 and number = 11) product_id
     , number
     , _index
  from page_lam_range where product_id = (select id from product where type = 11 and number = 7);