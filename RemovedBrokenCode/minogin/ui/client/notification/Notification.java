...
public class Notification extends Composite {
	...
	public static final int SHOW_TIME_SEC = 5;
	...
	protected void onAttach() {
		...
		}.run(BLUR_TIME_SEC * 1000, Duration.currentTimeMillis() + SHOW_TIME_SEC * 1000);
	}
	...
	public void show() {
		...
		style.setTop(Window.getScrollTop() + MARGIN_TOP, Unit.PX);
