 ...
 * the License.
 */
package ru.minogin.gwt.client.ui;
 ...
 * 
 * <p>
 * <h3>Example</h3> {@example com.google.gwt.examples.PopupPanelExample} </p>
...
public class FixedPopupPanel extends SimplePanel implements SourcesPopupEvents,
		EventPreview, HasAnimation, HasCloseHandlers<FixedPopupPanel> {
	...
	static class ResizeAnimation extends Animation {
		...
		private FixedPopupPanel curPanel = null;
		...
		public ResizeAnimation(FixedPopupPanel panel) {
			this.curPanel = panel;
		}
	 ...
	 * changes. */
	public FixedPopupPanel(boolean autoHide) {
		this();
	...
	public FixedPopupPanel(boolean autoHide, boolean modal) {
		this(autoHide);
		this.modal = modal;
	}
	...
	public HandlerRegistration addCloseHandler(CloseHandler<FixedPopupPanel> handler) {
...
//		ListenerWrapper.WrappedPopupListener.remove(this, listener);
	...
	private void previewNativeEvent(NativePreviewEvent event) {
		...
		boolean eventTargetsPopupOrPartner = eventTargetsPopup(nativeEvent)
				|| eventTargetsPartner(nativeEvent) || eventTargetsScrollBar(nativeEvent);
	...
	private boolean eventTargetsScrollBar(Event event) {
