...
@Entity
@Table(name = "flyleaf")
public class Flyleaf extends BaseEntityImpl {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Flyleaf))
            return false;

        Flyleaf flyleaf = (Flyleaf) obj;
        if (flyleaf.getId() == null || getId() == null)
            return false;

        return flyleaf.getId().equals(getId());
    }
